...
public class RNAutoupgradeModule extends ReactContextBaseJavaModule {
    ...
    public RNAutoupgradeModule(ReactApplicationContext reactContext, UpdateContext updateContext) {
        super(reactContext);
        this.updateContext = updateContext;
        this.reactContext = reactContext;
    }

    public RNAutoupgradeModule(ReactApplicationContext reactContext) {
        this(reactContext, new UpdateContext(reactContext.getApplicationContext()));
    }

    @Override
    public String getName() {
        return "RNAutoupgrade";
    }
    ...
    public Map<String, Object> getConstants() {
        ...
        constants.put("appVersionUpdated", updateContext.getAppVersionUpdated());
        constants.put("currentBundleVersion", updateContext.getCurrentBundleVersion());
    ...
    public void reloadUpdate(ReadableMap options) {
        ...
        final String currentBundleVersion = options.getString("currentBundleVersion");
        UiThreadUtil.runOnUiThread(new Runnable() {
            @Override
            public void run() {
                updateContext.switchVersion(hash,currentBundleVersion);
                try {

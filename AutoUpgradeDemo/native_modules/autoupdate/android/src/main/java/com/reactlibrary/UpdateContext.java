...
public class UpdateContext {
    ...
    public void switchVersion(String hashName, String currentBundleVersion) {
        ...
        editor.putString("lastAppVersionUpdated", getAppVersionUpdated());
        editor.putString("appVersionUpdated", getPackageVersion());
        editor.putString("lastBundleVersion", getCurrentBundleVersion());
        editor.putString("currentBundleVersion", currentBundleVersion);
    ...
    public String getCurrentBundleVersion() {
        return sp.getString("currentBundleVersion", "0");
    }

    public String getAppVersionUpdated() {
        return sp.getString("appVersionUpdated", null);
    }
    ...
    private String rollBack() {
        ...
        String lastBundleVersion = sp.getString("lastBundleVersion", "0");
        editor.putString("currentBundleVersion", lastBundleVersion);
        String lastAppVersionUpdated = sp.getString("lastAppVersionUpdated", null);
        editor.putString("appVersionUpdated", lastAppVersionUpdated);
        editor.putBoolean("firstTimeOk", true);
        editor.putBoolean("firstTime", false);
